...
const tabBar = {
  ...
  list: [
    ...
    },
    {
      ...
      iconPath: "static/image/monitor.png",
      selectedIconPath: "static/image/monitor-active.png",
      text: "\u76D1\u63A7"
    },
    {
      pagePath: "pages/control/control",
      iconPath: "static/image/control.png",
      selectedIconPath: "static/image/control-active.png",
      text: "\u63A7\u5236"
    },
    {
      pagePath: "pages/talk/talk",
      iconPath: "static/image/talk.png",
      selectedIconPath: "static/image/talk-active.png",
      text: "\u804A\u5929"
    }
  ]
};
...
let w;
w = m;
const v = p('{\n    "address": [\n        "127.0.0.1",\n        "192.168.92.1",\n        "10.202.7.99"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "remote",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "E:/\u8F6F\u4EF6\u5B89\u88C5\u5411\u5BFC/HBuilder/HBuilderX.3.6.14.20221215/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), S = p('[{"provider":"aliyun","spaceName":"my-servicespace1","spaceId":"mp-b5da9f29-16c3-4b2e-8e7a-301c7cfad1b7","clientSecret":"AGQu6lCqQyOahfYeGvUXzQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let I = "";
try {
  I = "__UNI__F9A7E58";
} catch (e2) {
